    ...
    clientsNearLimit: [
      {
        ...
        clientEmail: "alice@example.test",
        usageRatio: 0.84,
        limitingFactor: "email_limit_per_campaign",
        campaignsInUse: 2,
        maxCampaigns: 4,
        highestUsageCampaignId: "campaign_acme_welcome",
        highestUsageCampaignName: "Welcome Series",
        highestUsageCampaignVolume: 420,
        emailLimitPerCampaign: 500,
        maxCampaignsRatio: 0.5,
        emailLimitRatio: 0.84,
      },
    ],
